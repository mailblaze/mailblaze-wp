...
/**
 * Class MB4WP_WPForms_Integration
 *
 * @ignore
 */
class MB4WP_WPForms_Integration extends MB4WP_Integration {
    ...
    public function listen_to_wpforms( $fields, $entry, $form_data ) {
        ...
        foreach( $fields as $field_id => $field ) {
            if( $field['type'] === 'mailblaze' && $field['value_raw'] == 1 ) {
    ...
    public function subscribe_from_wpforms( $checkbox_field_id, $fields, $form_data ) {
        ...
        $mailblaze_list_id = $form_data['fields'][$checkbox_field_id]['mailblaze_list'];
