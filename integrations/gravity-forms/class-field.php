...
class MB4WP_Gravity_Forms_Field extends GF_Field {

    public $type = 'mailblaze';
    ...
    public function get_form_editor_field_title() {
        return esc_attr__( 'MailBlaze', 'mailblaze-for-wp' );
    }
    ...
    public function get_form_editor_field_settings() {
        return array(
            ...
            'description_setting',
            'css_class_setting',
            'mailblaze_list_setting',
            'mailblaze_double_optin',
            'rules_setting',
        );
    }
