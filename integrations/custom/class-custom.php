...
/**
 * Class MB4WP_Custom_Integration
 * @ignore
 */
class MB4WP_Custom_Integration extends MB4WP_Integration {

	/**
	 * @var string
	 */
	protected $checkbox_name = 'mb4wp-subscribe';
	...
	*/
	...
	public function listen() {
		...
		// (since they use the same "mb4wp-subscribe" trigger)
