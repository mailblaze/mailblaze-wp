<p>
	<?php _e( 'To get a custom integration to work, include the following HTML in the form you are trying to integrate with.', 'mailblaze-for-wp' ); ?>
</p>
...
<p>
	<label>
		...
		<?php _e( 'Subscribe to our newsletter.', 'mailblaze-for-wp' ); ?>
	</label>
</p>
