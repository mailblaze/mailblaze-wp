...
/**
 * Class MB4WP_Easy_Digital_Downloads_Integration
 *
 * @ignore
 */
class MB4WP_Easy_Digital_Downloads_Integration extends MB4WP_Integration {
	...
	public function triggered( $object_id = null ) {
		...
		if( is_array( $meta ) && isset( $meta['_mb4wp_optin'] ) && $meta['_mb4wp_optin'] ) {
			return true;
		}
