...
/**
 * Class MB4WP_WooCommerce_Integration
 *
 * @ignore
 */
class MB4WP_WooCommerce_Integration extends MB4WP_Integration {
	...
	*/
	public function save_woocommerce_checkout_checkbox_value( $order_id ) {
		update_post_meta( $order_id, '_mb4wp_optin', $this->checkbox_was_checked() );
	}
	...
	public function triggered( $order_id = null ) {
		...
		$do_optin = get_post_meta( $order_id, '_mb4wp_optin', true );
		return $do_optin;
	}
	...
	*/
	public function subscribe_from_woocommerce_checkout( $order_id ) {
		...
		// TODO: add billing address fields, maybe by finding MailBlaze field of type "address"?
