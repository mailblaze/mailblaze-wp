...
/**
 * Class MB4WP_Ninja_Forms_Field
 */
class MB4WP_Ninja_Forms_Field extends NF_Abstracts_Input
{
    protected $_name = 'mb4wp_optin';

    protected $_nicename = 'MailBlaze';
    ...
    public function __construct()
    {
        ...
        $this->_nicename = __( 'MailBlaze opt-in', 'mailblaze-for-wp' );
    ...
    public function custom_columns( $value, $field )
    {
        ...
        if( 'mb4wp_optin' == $field->get_setting( 'type' ) ) {
