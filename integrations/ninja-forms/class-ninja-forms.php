 ...
 * @ignore
 */
class MB4WP_Ninja_Forms_Integration extends MB4WP_Integration {
	...
	public function add_hooks() {
	    add_action( 'mb4wp_integration_ninja_forms_subscribe', array( $this, 'subscribe_from_ninja_forms' ), 10, 7 );
    }
