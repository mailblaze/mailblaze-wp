...
// vars
var context = document.getElementById('mb4wp-admin');
...
(0, _tlite2.default)(function (el) {
    return el.className.indexOf('mb4wp-tooltip') > -1;
});

// list fetcher
var ListFetcher = require('./admin/list-fetcher.js');
var mount = document.getElementById('mb4wp-list-fetcher');
if (mount) {
...
window.mb4wp.deps = window.mb4wp.deps || {};
window.mb4wp.deps.mithril = m;
window.mb4wp.helpers = helpers;
window.mb4wp.events = events;
window.mb4wp.settings = settings;
window.mb4wp.tabs = tabs;
...
function ListFetcher() {
    ...
    if (config.mailblaze.api_connected && config.mailblaze.lists.length === 0) {
        this.fetch();
    }
}
...
ListFetcher.prototype.fetch = function (e) {
    ...
    $.post(ajaxurl, {
        action: "mb4wp_renew_mailblaze_lists",
        timeout: 180000
    }).done(function (data) {
        this.success = true;
...
ListFetcher.prototype.view = function () {
    return m('form', {
        ...
        type: "submit",
        value: this.working ? i18n.fetching_mailblaze_lists : i18n.renew_mailblaze_lists,
        className: "button",
        disabled: !!this.working
    }), m.trust(' &nbsp; '), this.working ? [m('span.mb4wp-loader', "Loading..."), m.trust(' &nbsp; '), m('em.help', i18n.fetching_mailblaze_lists_can_take_a_while)] : '', this.done ? [this.success ? m('em.help.green', i18n.fetching_mailblaze_lists_done) : m('em.help.red', i18n.fetching_mailblaze_lists_error)] : ''])]);
};
...
var Settings = function Settings(context, helpers, events) {
	...
	var listInputs = context.querySelectorAll('.mb4wp-list-input');
	var lists = mb4wp_vars.mailblaze.lists;
	var selectedLists = [];
...
var Tabs = function Tabs(context) {
	...
	function _open(tab, updateState) {
		...
		if (tab.id === 'fields' && window.mb4wp && window.mb4wp.forms && window.mb4wp.forms.editor) {
			mb4wp.forms.editor.refresh();
		}
