...
class MB4WP_Admin_Tools {
    ...
    public function on_plugin_page( $page = null ) {
        // any settings page
        if( is_null( $page ) ) {
            return isset( $_GET['page'] ) && strpos( $_GET['page'], 'mailblaze-for-wp' ) === 0;
        }
    ...
    public function get_required_capability() {
         ...
         * @deprecated 3.0
         */
        $capability = apply_filters( 'mb4wp_settings_cap', $capability );

        /**
         * Filters the required user capability to access the MailBlaze for WordPress' settings pages, view the dashboard widgets.
         *
         ...
         */
        $capability = (string) apply_filters( 'mb4wp_admin_required_capability', $capability );
