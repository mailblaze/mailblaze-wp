...
/**
 * Class MB4WP_Dynamic_Content_Tags
 *
 * @access private
 * @ignore
 */
class MB4WP_Dynamic_Content_Tags {
	...
	public function all() {
         ...
         * @ignore
		 */
		$this->tags = (array) apply_filters( 'mb4wp_dynamic_content_tags', $tags );
         ...
         * @ignore
		 */
		$this->tags = (array) apply_filters( 'mb4wp_dynamic_content_tags_' . $context, $tags );
		return $this->tags;
	}
