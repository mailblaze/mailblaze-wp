...
class MB4WP_Queue {
    ...
    /**
     * MB4WP_Ecommerce_Queue constructor.
     *
     ...
     *
     * @return MB4WP_Queue_Job[] Array of jobs
     */
    public function all() {
    ...
    /**
     * @param MB4WP_Queue_Job $job
     */
    public function delete( MB4WP_Queue_Job $job ) {
     ...
     * @param MB4WP_Queue_Job $job
     */
    public function reschedule( MB4WP_Queue_Job $job  ) {
        if( is_null( $this->jobs ) ) {
            $this->load();
        }
