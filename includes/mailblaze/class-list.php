...
/**
 * Class MB4WP_MailBlaze_List
 *
 * Represents a list in MailBlaze
 *
 * @access public
 */
class MB4WP_MailBlaze_List {
	...
	/**
	 * @var string Web ID of this list in MailBlaze.com
	 */
	public $web_id = '';
	...
	/**
	 * @var MB4WP_MailBlaze_Merge_Field[]
	 */
	public $merge_fields = array();

	/**
	 * @var MB4WP_MailBlaze_Interest_Category[]
	 */
	...
	public function __construct( $id, $name, $web_id = '' ) {
		...
		// add email field
		$email_field = new MB4WP_MailBlaze_Merge_Field( 'Email Address', 'email', 'EMAIL', true );
	 ...
	 * @return MB4WP_MailBlaze_Interest_Category
	 *
	 * @throws Exception
	 */
	...
	/**
	 * Get link to this list in MailBlaze
	 *
	 * @return string
	 */
	public function get_web_url() {
		return 'https://control.mailblaze.com/customer/index.php/lists/' . $this->id . 	'/subscribers';
	}
	 ...
	 *
	 * @deprecated 4.0
	 * @use MB4WP_MailBlaze_List::get_interest_category
	 *
	...
	/**
	 * @deprecated 4.0
	 * @use MB4WP_MailBlaze_List::get_field_by_tag
	 *
	 * @param string $tag
	 *
	 * @return string
