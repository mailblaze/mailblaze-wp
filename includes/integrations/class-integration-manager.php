...
/**
 * Class MB4WP_Integration_Manager
 *
 * @ignore
 * @access private
 */
class MB4WP_Integration_Manager {
	...
	/**
	 * @var MB4WP_Integration_Fixture[]
	 */
	protected $integrations = array();

	/**
	 * @var MB4WP_Integration_Tags
	 */
	protected $tags;
	...
	*/
	public function __construct() {
		$this->tags = new MB4WP_Integration_Tags();
	}
	...
	public function initialize() {
		/*** @var MB4WP_Integration_Fixture $integration */
	 ...
	 *
	 * @return MB4WP_Integration_Fixture[]
	 * @throws Exception
	 */
	...
	public function register_integration( $slug, $class, $enabled = false ) {
		...
		$this->integrations[ $slug ] = new MB4WP_Integration_Fixture( $slug, $class, $enabled, $raw_options );
	}
	 ...
	 *
	 * @param MB4WP_Integration_Fixture $integration
	 *
	 * @return bool
	 */
	public function is_enabled( MB4WP_Integration_Fixture $integration ) {
	...
	private function load_options() {
		$options = (array) get_option( 'mb4wp_integrations', array() );
         ...
         * @ignore
		 */
		return (array) apply_filters( 'mb4wp_integration_options', $options );
	}
