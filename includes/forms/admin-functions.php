 ...
 * @return string
 */
function mb4wp_get_edit_form_url( $form_id, $tab = '' ) {
	$url = admin_url( sprintf( 'admin.php?page=mailblaze-for-wp-forms&view=edit-form&form_id=%d', $form_id ) );
 ...
 * @return string
 */
function mb4wp_get_add_form_url() {
	$url = admin_url( 'admin.php?page=mailblaze-for-wp-forms&view=add-form' );
	return $url;
}
 ...
 * @return string
 */
//function mb4wp_form_message_setting_row( $key, $label, $value = '', $help_text = '' ) {
//
//
//	$id = 'mb4wp_form_message_' . $key;
//	echo $name = sprintf( 'mb4wp_form[messages][%s]', $key );
//
//	echo '<tr valign="top">';
//
//	# Label
